        ...
        <div class="container mt-5">
            ...
            <div class="my-5 col-12 col-md-6">
                ...
                <form action="" method="post">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-primary" type="submit" name="createkategori">Create</button>
                    </div>
                </form>
                ...
                <?php
                    if(isset($_POST['createkategori'])){
                        ...
                        $querycekkategori = mysqli_query($con, "SELECT nama FROM kategori WHERE
                        nama='$kategori'");
                        $jumlahDataKategoriBaru = mysqli_num_rows($querycekkategori);
