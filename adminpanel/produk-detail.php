<?php
    ...
    //membuat MYSQL Join 
    //untuk membuat baris kategori sesuai dengan kategori yang dipilih
    $query = mysqli_query($con, "SELECT a.*, b.nama AS nama_kategori FROM produk 
    a JOIN kategori b ON a.kategori_id=b.id WHERE a.id='$id'");
    $data = mysqli_fetch_array($query);

    $queryKategori = mysqli_query($con, "SELECT * FROM kategori WHERE id!='$data[kategori_id]'");

    //mengacak nama file foto secara random
    //agar dapat meng-upload gamabar yang sama
...
<body>
    ...
    <!-- membuat Update dan Delete Produk-->
    <!-- membuat Tampilan Form  Update dan Delete-->
        <div class="col-12 col-md-6 mb-10">
            ...
            <?php
                if(isset($_POST['update'])){
                    ...
                    //membuat tanda warning wajib mengisi Form 
                        ...
                        if($nama_file!=''){
                            if($image_size > 500000){
                                ...
                                <?php
                                    ...
                                    $queryUpdate = mysqli_query($con, "UPDATE produk SET foto='$new_name' 
                                    WHERE id='$id'"); 
                                    ...
                                    if($queryUpdate){
                                        ...
                                        <!-- menggunakkan meta http equiv refresh untuk refresh page secara otomatis-->
